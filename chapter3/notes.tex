...
In this chapter we will derive the necessary optimality conditions, i.e., Karush-Kunh-Tucker (KKT) conditions, for the most general case where $C$ is possibly nonconvex. In particular, we consider problems of the following shape
...
\begin{theorem}[Gordon's Alternative Theorem]
...
Before stating and proving the KKT conditions, 

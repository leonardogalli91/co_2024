...
\DeclareMathOperator*{\hess}{\mathit{\nabla^2 \!f}}
...
\newcommand{\Cii}{\mathord{\mathrm{C^2}}}
\newcommand{\LC}{\mathord{\mathrm{C^{1,1}_{L}}}}
\newcommand{\LCii}{\mathord{\mathrm{C^{2,1}_{L}}}}
\newcommand{\bd}{\mathord{\mathrm{bd}}}
\newcommand{\cl}{\mathord{\mathrm{cl}}}
\newcommand{\diag}{\mathord{\mathrm{diag}}}
\newcommand{\interior}{\mathord{\mathrm{int}}}
\newcommand{\with}{\mathord{\mathrm{with }}\,}
\newcommand{\Tr}{\mathord{\mathrm{Tr}}}
\newcommand{\cone}{\mathord{\mathrm{cone}}}
\newcommand{\st}{\text{s.t.} \;\;\;}
\newcommand{\Rn}{\mathbb{R}^n}
\newcommand{\Rnn}{\mathbb{R}^{n\times n}}
\newcommand{\Rmn}{\mathbb{R}^{m\times n}}
\newcommand{\partiali}{\frac{\partial f}{\partial x_i}}
...
\renewcommand{\theexample}{\chapter.\arabic{example}}
\renewcommand{\thedefinition}{\chapter.\arabic{definition}}
\renewcommand{\thelemma}{\chapter.\arabic{lemma}}
\renewcommand{\theproposition}{\chapter.\arabic{proposition}}
\renewcommand{\thetheorem}{\chapter.\arabic{theorem}}
\renewcommand{\thecorollary}{\chapter.\arabic{corollary}}
\renewcommand{\theremark}{\chapter.\arabic{remark}}

...
\end{algorithm}
\noindent Notice that to prove convergence it suffices to show that also in this case we can derive a decrease as in \eqref{eq:decrease}, where the step size is replaced by a constant term. In particular, from the Lemma above, we get
\begin{equation*}
